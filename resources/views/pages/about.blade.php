                    ...
                    <ul>
                        ...
                        <li data-index="rs-18" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                            ...
                            <div class="tp-caption" data-x="['center','center','center','center']"
                                ...
                                <a href="{{ route('about') }}" class="custom-button slider-button scroll-to-target">learn
                                    more about
                                    us</a>
                            </div>
                        </li>
                ...
                <div class="row about-content">
                    <div class="col-sm-12 col-md-6 col-lg-6 about-left-side">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="menu2" class="tab-pane fade">
                                <p>
                                    The goal of this organisation is to improve the living standard of the people living across Baltistan in collaboration with local communities while the objectives are;<br>
                    ...
                    <div class="col-md-6 col-lg-6 about-right-side">
                        <div class="full-image-container hovered">
                            <img class="img-responsive hidden-xs" src="{{ asset('custom/img/about.jpg') }}" alt="">
            ...
            <div class="section-overlay">
                ...
                <div class="container">
                    ...
                    <div class="text-center top-text">
                        ...
                        <h4>A Short Video For Information</h4>
                    </div>
                    <!-- Main Heading Ends -->
                    <div class="video-content">
                        <p class="text-center"><br>
                            Water Diversion from Fiya Lung to Satpara Dam
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap" href="img/projects/project-1.jpg') }}"
                                        data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive"
                                            src="{{ asset('custom/img/projects/project-1.jpg') }}"
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap mfp-youtube"
                                        href="https://www.youtube.com/watch?v=0gv7OC9L2s8"><img class="img-responsive"
                                            src="{{ asset('custom/img/projects/project-2.jpg') }}"
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap" href="img/projects/project-3.jpg') }}"
                                        data-gal="magnific-pop-up[gallery]" title="Gallery project"><img
                                            class="img-responsive" src="{{ asset('custom/img/projects/project-3.jpg') }}"
                            ...
                            <div class="magnific-popup-gallery">
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap" href="image-project.html" title="portfolio"><img
                                            class="img-responsive" src="{{ asset('custom/img/projects/project-4.jpg') }}"
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap mfp-youtube"
                                        href="https://www.youtube.com/watch?v=O_C5CN1L3Xo"><img class="img-responsive"
                                            src="{{ asset('custom/img/projects/project-6.jpg') }}"
                                            alt="Gallery project" /><span class="zoom-icon video-icon"></span></a>
                                </figure>
                                <!-- Thumbnail Ends -->
                                <!-- Caption Starts -->
                            ...
                            <div class="magnific-popup-gallery">
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap" href="img/projects/project-7.jpg') }}"
                                        data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive"
                                            src="{{ asset('custom/img/projects/project-7.jpg') }}"
                                            alt="Image Project" /><span class="zoom-icon"></span></a>
                                </figure>
                                <!-- Thumbnail Ends -->
                                <!-- Caption Starts -->
                            ...
                            <div class="magnific-popup-gallery">
                                ...
                                <figure class="thumbnail thumbnail__portfolio">
                                    <a class="image-wrap mfp-vimeo" href="https://vimeo.com/23534361"><img
                                            class="img-responsive" src="{{ asset('custom/img/projects/project-8.jpg') }}"
                                            alt="Gallery project" /><span class="zoom-icon video-icon"></span></a>
                                </figure>
                                <!-- Thumbnail Ends -->
                                <!-- Caption Starts -->
        ...
        <section class="logos">
            <div class="container">
                <ul class="bxslider" id="bxslider">
                    <!-- Logos Items Starts -->
                    <li><img id="3docean" src="{{ asset('custom/images/logo.png') }}" alt="3docean"></li>
                    <li><img id="activeden" src="{{ asset('custom/images/logo.png') }}" alt="activeden"></li>
                    <li><img id="audiojungle" src="{{ asset('custom/images/logo.png') }}" alt="audiojungle"></li>
                    <li><img id="codecanyon" src="{{ asset('custom/images/logo.png') }}" alt="codecanyon"></li>
                    <li><img id="graphicriver" src="{{ asset('custom/images/logo.png') }}" alt="graphicriver"></li>
                    <li><img id="photodune" src="{{ asset('custom/images/logo.png') }}" alt="photodune"></li>
                    <li><img id="themeforest" src="{{ asset('custom/images/logo.png') }}" alt="themeforest"></li>
                    <!-- Logos Items Ends -->
                </ul>
            </div>
        </section>
