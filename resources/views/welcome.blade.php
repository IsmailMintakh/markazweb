...
<div class="preloader" id="preloader">
        <div class="logopreloader">
            <img src="{{ asset('custom/images/logo.png') }}" alt="logo-black">
        </div>
            ...
            <div id="rev_slider_kenburns" class="rev_slider fullwidthabanner" style="display:none;"
                ...
                <ul>
                    ...
                    <li data-index="rs-18" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut"
                        ...
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{ asset('custom/images/bg1.webp') }}" data-bgposition="center center"
                            data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100"
                            data-scaleend="180" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0"
                        ...
                        <div class="tp-caption" data-x="['center','center','center','center']"
                            ...
                            <a href="{{ route('about') }}" class="custom-button slider-button scroll-to-target">learn more about
                                us</a>
                        </div>
                    </li>
                    <!-- SLIDE  -->
                    <li data-index="rs-2" data-transition="zoomin" data-slotamount="default" data-easein="default"
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{ asset('custom/img/revolution-slider/kenburns/kenburns2.jpg') }}"
                            data-bgposition="center center" data-kenburns="on" data-duration="30000"
                            data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="180" data-rotatestart="0"
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                            ...
                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000"
                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                            data-elementdelay="0.05" style="z-index: 5; white-space: nowrap;">
                            For Drinking
                        </div>
                    ...
                    <li data-index="rs-3" data-transition="zoomin" data-slotamount="default" data-easein="default"
                        ...
                        data-description="">
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{ asset('custom/img/revolution-slider/kenburns/kenburns3.jpg') }}"
                            data-bgposition="center center" data-kenburns="on" data-duration="30000"
                            data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="180" data-rotatestart="0"
                            data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10"
                            class="rev-slidebg" data-no-retina>
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                            ...
                            data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1000"
                            data-splitin="chars" data-splitout="none" data-responsive_offset="on"
                            data-elementdelay="0.05" style="z-index: 5; white-space: nowrap;">By People of Skardu 
                        </div>
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                            ...
                            data-splitin="none" data-splitout="none" data-responsive_offset="on"
                            style="z-index: 6; white-space: nowrap;">
                            headed by Agha Baqir Alhussaini
                        </div>
        ...
        <div class="container">
            ...
            <div class="row about-content">
                <div class="col-sm-12 col-md-6 col-lg-6 about-left-side">
                    <h3 class="title-about">WE ARE <strong>AFTAB</strong></h3>
                    <hr>
                    <p></p>
                    <!-- Tabs Heading Starts -->
                    <ul class="nav nav-tabs">
                        <li class="active"><a data-toggle="tab" href="#menu1">Introduction</a></li>
                        <li><a data-toggle="tab" href="#menu2">Objectives</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="menu2" class="tab-pane fade">
                            <p>The goal of this organisation is to improve the living standard of the people living across Baltistan in collaboration with local communities while the objectives are;<br>
• To minimise miseries of the people living in Skardu by providing necessities of live and facilitate people in collaboration with local communities and national & international development agencies.<br>
• To create inter faith harmony in Baltistan and increase coordination between various segments of the society as well revive the tradition of unity of Baltistan and initiate self-help basis communal projects.</p>
                        </div>
                    ...
                    <!-- Tabs Content Ends -->
                    <a class="custom-button" href="{{ route('about') }}">Learn more about us</a>
                </div>
                <div class="col-md-6 col-lg-6 about-right-side">
                    <div class="full-image-container hovered">
                        <img class="img-responsive hidden-xs" src="{{ asset('custom/images/3.jpg') }}" alt="">
                        <div class="full-image-overlay">
                            <h3>Project<strong> Outcomes</strong></h3>
                            <ul class="list-why-choose-us">
                                <li>Social harmony </li>
                                <li>Provision of water </li>
                                <li>production crop and fruit</li>
                                <li>farm related jobs and businesses</li>
                                <li>Improve health and hygiene </li>
                                <li>Increase greenery </li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <section class="videopromotion">
        <div class="section-overlay">
            ...
            <div class="container">
                <!-- Main Heading Starts -->
                <div class="text-center top-text">
                    <h1><span>Short</span> Video</h1>
                    <h4>Made with love for you</h4>
                </div>
                <!-- Main Heading Ends -->
                <div class="video-content">
                    <p class="text-center">Water Diversion from Fiya Lung to Satpara Dam
For Drinking, Irrigation and Electricity 
</p>
                    <!-- Video Play Starts -->
                    <div class="magnific-popup-gallery">
                        <div class="btn-wrapper text-center"><a class="image-wrap mfp-youtube"
                                href="{{ asset('custom/video/skd.mp4') }}"></a></div>
                    </div>
                    <!-- Video Play Ends -->
                </div>
            </div>
   ...
   <section class="testimonials">
            <div class="section-overlay">
                ...
                <div class="container">
                    <!-- Main Heading Starts -->
                    <div class="text-center top-text">
                        <h1><span>Personalities</span> Saying</h1>
                        <h4>About Project</h4>
                    </div>
                    <!-- Main Heading Starts -->
                    <!-- Blockquotes Starts -->
                    <div id="quote-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="item active">
                                <blockquote>
                                    <img class="img-circle img-responsive" src="{{ asset('custom/images/jaffari.jpeg') }}" alt="client">
                                    <p>
                                    ...
                                    <h5>Allama Sheikh Muhammad Hassan Jaffari</h5>
                                    <h6>Imam-e-jumma Skardu</h6>
                                </blockquote>
                            </div>
                            <!-- Quote #1 Ends -->
                            <!-- Quote #2 Starts -->
                            <div class="item">
                                <blockquote>
                                    ...
                                    <h5>Allama Sheikh Muhammad Jawad Hafizi</h5>
                                    <h6>Naib Imam-e-jumma Skardu</h6>
                                </blockquote>
                            </div>
                            <!-- Quote #2 Ends -->
                            <!-- Quote #3 Starts -->
                            <div class="item">
                                <blockquote>
                                    ...
                                    <h5>Allama Sheikh Muhammad Hassan Sarwari</h5>
                                    <h6>Naib Imam-e-jumma Skardu</h6>
                                </blockquote>
                            </div>
                            <!-- Quote #3 Ends -->
                ...
                <div class="filtr-container">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 filtr-item" data-category="1">
                        <div class="magnific-popup-gallery">
                            ...
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="{{ asset('custom/images/deosai/437524-mountains-natural-light-nature-sky-water-landscape.jpg') }}"
                                    data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive"
                                        src="{{ asset('custom/images/deosai/437524-mountains-natural-light-nature-sky-water-landscape.jpg') }}"
                        ...
                        <div class="magnific-popup-gallery">
                            ...
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap mfp-youtube"
                                    href="{{ asset('custom/images/deosai/HD-wallpaper-deosai-plateau-pakistan-pakistan-deosai-beautiful-plateau.jpg') }}"><img class="img-responsive"
                                        src="{{ asset('custom/images/deosai/HD-wallpaper-deosai-plateau-pakistan-pakistan-deosai-beautiful-plateau.jpg') }}"
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 filtr-item" data-category="1">
                        <div class="magnific-popup-gallery">
                            <!-- Thumbnail Starts -->
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="{{ asset('custom/images/deosai/water-cloud-sky-cloudscape.jpg') }}"
                                    data-gal="magnific-pop-up[gallery]" title="Gallery project"><img
                                        class="img-responsive" src="{{ asset('custom/images/deosai/water-cloud-sky-cloudscape.jpg') }}"
                                        alt="Gallery project" /><span class="zoom-icon gallery-icon"></span></a>
                            </figure>
                            <a href="{{ asset('custom/images/deosai/i-saw-a-small-fish-in-a-wat.jpg') }}" title="Gallery project"
                        ...
                        <div class="magnific-popup-gallery">
                            ...
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="image-project.html" title="portfolio"><img
                                        class="img-responsive" src="{{ asset('custom/img/projects/pject-4.jpg') }}"
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 filtr-item" data-category="1">
                        <div class="magnific-popup-gallery">
                            <!-- Thumbnail Starts -->
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="img/projects/project.pg') }}"
                                    data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive"
                                        src="{{ asset('custom/img/projects/project-5.jpg') }}"
                                        alt="Image Project" /><span class="zoom-icon"></span></a>
                            </figure>
                            <!-- Thumbnail Ends -->
                            <!-- Caption Starts -->
                            ...
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap mfp-youtube"
                                    href="https://www.youtube.com/watch?v=O_C5CN1L3Xo"><img class="img-responsive"
                                        src="{{ asset('custom/img/projects/projec.jpg') }}"
                                        alt="Gallery project" /><span class="zoom-icon video-icon"></span></a>
                            </figure>
                            <!-- Thumbnail Ends -->
                            <!-- Caption Starts -->
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-4 filtr-item" data-category="1">
                        <div class="magnific-popup-gallery">
                            <!-- Thumbnail Starts -->
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="img/projects/project') }}"
                                    data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive"
                                        src="{{ asset('custom/img/projects/projec7.jpg') }}"
                                        alt="Image Project" /><span class="zoom-icon"></span></a>
                            </figure>
                            <!-- Thumbnail Ends -->
                            <!-- Caption Starts -->
                    ...
                    {{-- <div class="col-xs-12 col-sm-4 col-md-4 filtr-item" data-category="2">
                        <div class="magnific-popup-gallery">
                            <!-- Thumbnail Starts -->
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap mfp-vimeo" href=""><img
                                        class="img-responsive" src="{{ asset('custom/images/deoasi/i-saw-a-small-fish-in-a-wat.jpg') }}"
                                        alt="Gallery project" /><span class="zoom-icon video-icon"></span></a>
                            </figure>
                            <!-- Thumbnail Ends -->
                            <!-- Caption Starts -->
                            ...
                            <figure class="thumbnail thumbnail__portfolio">
                                <a class="image-wrap" href="img/projects/project-9.jpg') }}"
                                    data-gal="magnific-pop-up[gallery]" title="Slider project"><img
                                        class="img-responsive" src="{{ asset('custom/img/projects/project-9.jpg') }}"
        ...
        <div class="section-overlay">
            ...
            <div class="container">
                ...
                <div class="newsletter-content">
                    <p class="text-center">Sign up to our newsletter subscription and be the first to know about<br>
                        Important news <span> & </span> Amazing offers <span> & </span>Discounts</p>
                    ...
                    <form class="form-inputs">
                        ...
                        <button id="submit" name="submit" type="submit" class="custom-button" title="Send">Subscribe
                            Now</button>
            ...
            <div class="row latest-posts-content">
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        ...
                        <a class="img-thumb" href="blog-post.html"><img class="img-responsive"
                                src="{{ asset('custom/img/blog/blog-post-small-1.jpg') }}" alt="img"></a>
                        <!-- Featured Image Ends -->
                        ...
                        <div class="post-body">
                            ...
                            <div class="post-text">
                                <p>incididunt ut labore et dolore magna aliqua. Ut enim aminim veniam, quis nostrud...
                                </p>
                            </div>
                        </div>
                        <!-- Post Date Starts -->
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        <!-- Featured Image Starts -->
                        <a class="img-thumb" href="blog-post.html"><img class="img-responsive"
                                src="{{ asset('custom/img/blog/blog-post-small-2.jpg') }}" alt="img"></a>
                        <!-- Featured Image Ends -->
                        <!-- Article Content Starts -->
                        <div class="post-body">
                            <h4 class="post-title">
                ...
                <div class="col-sm-4 col-md-4 col-xs-12">
                    <div class="latest-post">
                        <!-- Featured Image Starts -->
                        <a class="img-thumb" href="blog-post.html"><img class="img-responsive"
                                src="{{ asset('custom/img/blog/blog-post-small-3.jpg') }}" alt="img"></a>
                        <!-- Featured Image Ends -->
                        <!-- Article Content Starts -->
                        <div class="post-body">
                            <h4 class="post-title">
    ...
    <section class="logos">
        <div class="container">
            <ul class="bxslider" id="bxslider">
                <!-- Logos Items Starts -->
                <li><img id="3docean" src="{{ asset('custom/img/logos-slider/3docean-dark-background.png') }}"
                        alt="3docean">
                </li>
                <li><img id="activeden" src="{{ asset('custom/img/logos-slider/activeden-dark-background.png') }}"
                        alt="activeden"></li>
                <li><img id="audiojungle" src="{{ asset('custom/img/logos-slider/audiojungle-dark-background.png') }}"
                        alt="audiojungle"></li>
                <li><img id="codecanyon" src="{{ asset('custom/img/logos-slider/codecanyon-dark-background.png') }}"
                        alt="codecanyon"></li>
                <li><img id="graphicriver" src="{{ asset('custom/img/logos-slider/graphicriver-dark-background.png') }}"
                        alt="graphicriver">
                </li>
                <li><img id="photodune" src="{{ asset('custom/img/logos-slider/photodune-dark-background.png') }}"
                        alt="photodune"></li>
                <li><img id="themeforest" src="{{ asset('custom/img/logos-slider/themeforest-dark-background.png') }}"
                        alt="themeforest"></li>
                <!-- Logos Items Ends -->
            </ul>
        </div>
